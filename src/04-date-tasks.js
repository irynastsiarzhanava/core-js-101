 ...
 * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Numbers_an  d_dates#Date_object
...
function timeSpanToString(startDate, endDate) {
  ...
  return new Date(timespan).toISOString().substring(11, 23);
}
...
function angleBetweenClockHands(date) {
  ...
  let angle = Math.abs(0.5 * (60 * h - 11 * min));
